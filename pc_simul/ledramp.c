...
int main(int argc, char *argv[]) {
  ...
  printf(
      "Demo launching: 'LED' bar is PORTB, updated every 1/64s by the AVR\n"
  ...
  glutInitWindowSize(8 * pixsize,
                     1 * pixsize);   /* width=400pixels height=500pixels */
